...
public class BasicEconomyPlugin extends Plugin {
	...
	public void loadGoods() {
		...
		FoodNeed.kJoules.put(create("crop",0.1f, 1).setOptimalNbDayStock(300).get(), 2000);
		FoodNeed.kJoules.put(create("fish",0.5f, 4).setOptimalNbDayStock(2).get(), 2000);
		FoodNeed.kJoules.put(create("rare_fish",0.9f, 10).setOptimalNbDayStock(1).get(), 2000);
		FoodNeed.kJoules.put(create("meat",0.5f, 3).setOptimalNbDayStock(2).get(), 2000);
		FoodNeed.kJoules.put(create("rare_meat",0.9f, 6).setOptimalNbDayStock(1).get(), 2000);
